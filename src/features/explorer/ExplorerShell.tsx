...
export default function ExplorerShell(){
  ...
  return <div className="explorer-app">
    ...
    {state.initialDataStatus==="error"&&<main className="explorer-stage loading-stage"><ExplorerStatus kind="error" onRetry={()=>{setInitialError(null);dispatch({type:"status",key:"initialDataStatus",value:"loading"});setRetry(x=>x+1)}}>{initialError}.</ExplorerStatus><Link href="/">Return Home</Link></main>}
